...
As of version 10 it would appear indexA and indexB have been retired as most 
edm files have then as empty (e.g. length = 0).  Keeping the informatin for 
the older version 8 format just incase.
